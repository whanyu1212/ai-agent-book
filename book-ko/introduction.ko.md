...
이 선수 지식 가운데 일부가 부족하더라도 낙담하지 마십시오. 이 책의 핵심 가치는 특정 알고리즘이나 기술이 아니라 **아키텍처 설계 원칙과 엔지니어링 방법론**에 있습니다. 사후 학습을 다루는 7장을 제외하면 수학이나 머신러닝 지식을 거의 요구하지 않으며, 입문서로 읽기에도 충분합니다.
