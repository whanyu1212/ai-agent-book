...
{\fontsize{30}{37}\selectfont\rmfamily\bfseries Memahami AI Agent\par}
\vspace{0.15cm}
{\fontsize{30}{37}\selectfont\rmfamily\bfseries secara Mendalam\par}
\vspace{0.45cm}
{\Large\sffamily\color{structurecolor} Prinsip Desain dan Praktik Rekayasa\par}
...
\vspace{0.35cm}
{\small\sffamily Terjemahan bahasa Indonesia: JOICE HIELMAN ABBRORI\par}
\vspace{0.45cm}
{\small\sffamily\color{structurecolor!80} Versi v1.4 · \today\par}
\vspace{1.2cm}
\end{titlepage}
