...
| 6-11 | [openvla-robotwin2-eval](openvla-robotwin2-eval/) | 🚧 | OpenVLA + RoboTwin2 구성과 업스트림 버전, 사전 점검·증거 게이트를 고정합니다. 완료하려면 실제 체크포인트와 RoboTwin2 환경, GPU 8개를 사용한 시뮬레이션 평가가 필요합니다. |
