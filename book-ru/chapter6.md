...
В сопутствующем эксперименте все три системы прошли одни и те же 60 вопросов; сохранено 180 реальных траекторий API. В таблице 6-4 проценты приведены вместе с числом успешных случаев.

Таблица 6-4. Успешность систем памяти по уровням задач
...
Ручные рубрики быстро задают такие диагностические измерения. В большем масштабе оценку можно автоматизировать специализированной **генеративной моделью вознаграждения**; её обучение рассматривается в главе 7.
...
> **Эксперимент 6-7 ★★: Измерение порога действия модели в фиксированном Coding Harness**
>
...
> **Эксперимент 6-8 ★: сквозной анализ стоимости задач агента**
>
...
> **Эксперимент 6-9 ★★: многомерное бенчмарк-тестирование производительности моделей**
>
...
>
> **Эксперимент 6-10 ★★: сквозная оценка выбора системы памяти пользователя**
>
...
Таблица 6-6 суммирует измеренные результаты. Четырёх задач на ветвь достаточно, чтобы решить, стоит ли расширять запуск, но не для оценки всего AndroidWorld.

Таблица 6-6. Три раунда на Wi-Fi-срезе AndroidWorld
...
> **Эксперимент 6-11 ★★★: оценка и улучшение AndroidWorld**
>
...
> **Эксперимент 6-12 ★★: настройка воплощённой интеллектуальной среды с OpenVLA и RoboTwin2**
>
