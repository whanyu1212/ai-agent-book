...
>
> Cần lưu ý rằng bản chất của thí nghiệm này—tìm kiếm nhiều vòng do mô hình chủ động quyết định, thực thi mã theo vòng kín ở phía máy chủ và làm rõ ý định trước khi thực thi—không bị ràng buộc với một nhà cung cấp cụ thể. Độc giả không có tín dụng OpenAI vẫn có thể tái lập bằng nhà cung cấp có các công cụ được quản lý tương đương. Chẳng hạn, Responses API của qwen3.7-plus trên Alibaba Cloud Bailian cũng tích hợp sẵn `web_search` và `code_interpreter`; mã đi kèm chương này (`chapter1/search-codegen`) đã thực sự chạy cả hai tác vụ nêu trên bằng API đó: tính khoảng cách giữa các thủ đô ASEAN và phân tích kỹ thuật Bitcoin. Tìm kiếm được quản lý bởi Formula và `code_runner` của Kimi K3 cũng cung cấp cùng loại năng lực.
>
...
LoopX là một framework cụ thể cho ý tưởng này: nó đưa mục tiêu, cổng quyết định, việc cần làm, bằng chứng, hạn mức, bàn giao, xác minh và điều kiện dừng vào một mặt phẳng điều khiển bền vững bên ngoài mô hình và cuộc trò chuyện, để các Agent trong những runtime khác nhau có thể cùng làm việc trên một vòng lặp có thể khôi phục và kiểm tra. Chương 10 dùng LoopX để cho thấy Loop Engineering trở thành một hệ thống thực tế như thế nào.
...
Guardrails cũng có một kiểu thất bại khác: **từ chối nhầm**. Để giảm khả năng cho phép yêu cầu nguy hiểm, mô hình có thể đồng thời từ chối những công việc hợp pháp nhưng có vẻ nhạy cảm, chẳng hạn như kiểm thử bảo mật được ủy quyền, đánh giá mô hình hoặc nghiên cứu chưng cất. Vì vậy, việc đánh giá guardrails không chỉ kiểm tra xem yêu cầu bị cấm có được ngăn chặn hay không mà còn phải kiểm tra xem yêu cầu được phép rõ ràng có thể hoàn thành bình thường hay không. Với nhiệm vụ hợp pháp nhưng nhạy cảm, hệ thống lý tưởng nên đưa ra lời giải thích, chuyển cấp cho con người hoặc cung cấp một đường thực thi đã được ủy quyền, thay vì chỉ trả về lời từ chối chung chung.
