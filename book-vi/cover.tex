...
{\fontsize{37}{46}\selectfont\rmfamily\bfseries Hiểu sâu về AI Agent\par}
\vspace{0.5cm}
{\Large\sffamily\color{structurecolor} Nguyên lý thiết kế và thực hành kỹ thuật\par}
...
\vfill
{\LARGE\sffamily Lý Bác Kiệt\quad Tác giả\par}
\vspace{0.7cm}
{\small\sffamily\color{structurecolor!80} Bản v1.4 · \number\year-\number\month-\number\day\par}
\vspace{1.2cm}
\end{titlepage}
