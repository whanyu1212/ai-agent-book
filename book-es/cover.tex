...
{\fontsize{33}{41}\selectfont\rmfamily\bfseries Agentes de IA en Profundidad\par}
\vspace{0.5cm}
{\Large\sffamily\color{structurecolor} Principios de Diseño y Práctica de Ingeniería\par}
...
\vspace{0.7cm}
{\small\sffamily\color{structurecolor!80} Versión v1.4 · \today\par}
\vspace{1.2cm}
\end{titlepage}
