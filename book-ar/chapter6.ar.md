...
![الشكل 6-1: المستويات الثلاثة لنظام التقييم](images/fig6-1.svg)
...
>
>
> ![الشكل 6-3: بنية تقييم مقاعد البدلاء τ²](images/fig6-3.svg)
>
>
...
![الشكل 6-4: LLM خط أنابيب القاضي](images/fig6-4.svg)
...
شغّلت التجربة المصاحبة الأنظمة الثلاثة على الأسئلة الستين نفسها، واحتفظت بـ180 مسارًا حقيقيًا لاستدعاءات API. يعرض الجدول 6-4 النسب وأعداد الإجابات الناجحة معًا.

الجدول 6-4 معدل النجاح بحسب نظام الذاكرة ومستوى المهمة
...
تساعد نماذج التقييم المكتوبة يدويًا على إنشاء هذه الأبعاد التشخيصية بسرعة. وعند التوسع، يمكن تدريب **نماذج مكافأة توليدية** متخصصة لأتمتة التحكيم؛ ويتناول الفصل السابع طريقة تدريبها.
...
![الشكل 6-5: تصنيف Elo وتصنيف المقارنة الزوجية](images/fig6-5.svg)
...
> **التجربة 6-7 ★★: قياس عتبة فعل النموذج داخل Coding Harness ثابت**
>
...
> **التجربة 6-8 ★: تحليل التكلفة الشاملة لمهام الوكيل**
>
...
> **التجربة 6-9 ★★: قياس أداء النموذج متعدد الأبعاد**
>
...
>
> **التجربة 6-10 ★★: تقييم الاختيار الشامل لأنظمة ذاكرة المستخدم**
>
...
![الشكل 6-6: حزمة تكنولوجيا إمكانية الملاحظة](images/fig6-6.svg)
...
![الشكل 6-7: المعيار لحلقة التحسين](images/fig6-7.svg)
...
يلخص الجدول 6-6 النتائج المقاسة. ومع أربع مهام فقط في كل فرع، تكفي هذه الأرقام لتقرير جدوى تشغيل أوسع، لكنها لا تقدّر النجاح على AndroidWorld كله.

الجدول 6-6 ثلاث جولات على شريحة Wi-Fi من AndroidWorld
...
> **التجربة 6-11 ★★★: التقييم والتحسين في AndroidWorld**
>
...
![الشكل 6-8: طيف دقة المحاكاة](images/fig6-8.svg)
...
> **التجربة 6-12 ★★: تكوين بيئة الذكاء المضمنة لـ OpenVLA وRoboTwin2**
>
...
>
>
> ![الشكل 6-9: بيئة الذكاء المتجسد OpenVLA وRoboTwin2](images/fig6-9.svg)
>
>
...
6. ★★ يقترح هذا الفصل المنهج العلمي "الملاحظة → الافتراض → التجربة → التحقق من الصحة". ومع ذلك، من الناحية العملية، فإن مساحة سلوك الوكيل واسعة، وقد يتطلب التحقق من صحة فرضية واحدة مئات من عمليات التقييم. كيف يمكن تعظيم المعلومات المكتسبة من التقييم في ظل ميزانية حسابية محدودة؟
