...
**10. (★★★) تنص المقدمة على أن "مبادئ التصميم الجيد يجب أن تتجاوز دورات تكرار النموذج." قدم مثالاً لمبدأ تصميم الوكيل الحالي الذي تعتقد أنه قد يصبح قديمًا مع تحسن النماذج، واشرح أسبابك.**

> أمثلة: التوجيه بأمثلة قليلة وهندسة الموجّهات الدقيقة - تقليل العوائد بمجرد تحسن التعميم من دون أمثلة؛ تنسيقات استدعاء الأدوات الصارمة التي يتم فرضها من خلال أخذ العينات المقيدة - تنسيقات استدعاء الأدوات لنماذج SOTA الحالية مستقرة إلى حد ما بالفعل؛ عمليات سير عمل متعددة الخطوات منسقة يدويًا - لم تعد هناك حاجة إليها بمجرد تحسن قدرة النموذج على متابعة التعليمات.
...
> إن ما نحتاج إليه بشدة هو القدرة على إجراء جلسات متعددة تعتمد على الأحداث. MCP هو الرد على الطلب في جوهره؛ البدائيات مثل الإشعارات، والتقدم، وأخذ العينات، والاستنباط كلها تقتصر على جلسة واحدة متصلة - يمكن أن يقول الإشعار فقط "تم تغيير المورد"؛ لا توجد طريقة قياسية لتحفيز حلقة تفكير الوكيل، ناهيك عن إيقاظ الوكيل غير المتصل بالإنترنت.
