...
1. **مفسّر الشفرة**: يوفر وضع حماية معزولًا (وقت تشغيل آمن منفصل عن النظام المضيف) حيث يمكن تشغيل كود Python بأمان دون أن تؤثر أخطاء التنفيذ على المضيف
2. **Bash Shell**: ينفذ الأوامر في الوحدة الطرفية، مثل تشغيل حالات الاختبار أو معالجة الملفات ذات التنسيق الخاص
3. **أداة قراءة الملف**: تقرأ التعليمات البرمجية والتكوين والوثائق والسجلات وما إلى ذلك.
4. **أداة كتابة الملف**: إنشاء ملفات جديدة أو الكتابة فوق الملفات الموجودة بالكامل
5. **أداة تحرير الملف**: لإجراء تعديلات جزئية على الملفات الموجودة، وهي عملية أساسية لصيانة التعليمات البرمجية وتكرارها
6. **أداة البحث عن اسم الملف (Glob)**: تحدد موقع الملفات المستهدفة بسرعة في نظام الملفات عبر مطابقة الأنماط، على سبيل المثال، استخدام `**/*.py` للعثور على جميع ملفات Python في المشروع
7. **أداة محتوى ملف البحث (Grep)**: تبحث عن أنماط نصية محددة داخل محتوى الملف، على سبيل المثال، العثور على جميع أسطر التعليمات البرمجية التي تستدعي وظيفة معينة
...
8. ★★ يسمح النمط Artifact بتنفيذ تعليمات SQL أو تعليمات برمجية للواجهة الأمامية تم إنشاؤها بواسطة وكيل مباشرة في متصفح المستخدم أو قاعدة بياناته. لكن SQL التي تم إنشاؤها قد تؤدي إلى عمليات مدمرة، وقد يحتوي HTML الذي تم إنشاؤه على ثغرات أمنية. كيف يمكن ضمان أمن النظام؟
