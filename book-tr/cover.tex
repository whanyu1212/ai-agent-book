...
{\fontsize{30}{38}\selectfont\rmfamily\bfseries AI Agent'ları Derinlemesine Anlamak\par}
\vspace{0.5cm}
{\Large\sffamily\color{structurecolor} Tasarım İlkeleri ve Mühendislik Pratiği\par}
...
\vspace{0.7cm}
{\small\sffamily\color{structurecolor!80} Sürüm v1.4 · \today\par}
\vspace{1.2cm}
\end{titlepage}
