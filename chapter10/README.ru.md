...
| 10-8 | [voice-werewolf](voice-werewolf/) | 🚧 | Добавлен настоящий LLM-симулятор пользователя: он видит только контекст своего места, вызывает инструменты и входит в игру лишь через синтезированный звук и настоящий аудио-ASR OpenRouter. Строгая проверка отклонила два ранних запуска, где плохой транскрипт приняли за воздержание; корректный v2 прошёл E2E, изоляцию, победителя и три цикла, но провалил стратегию после ошибочного изгнания провидца жителем. |
## Типы проектов
